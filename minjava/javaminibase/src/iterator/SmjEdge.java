...
public class SmjEdge {
	...
	//
	public void joinOperation(String filename1, String filename2, String res_filename, int joinRelationsType, boolean asc_order) throws 
	UnknowAttrType, LowMemException, JoinsException, Exception {
		...
		while (t != null) {
			try {
				...
				for (int i = 1; i <= resNumCols; i++) {
					if (i == 1 || i == 7 || i == 13)
						System.out.print(t.getStrFld(i) + " ");
					else
						System.out.print(t.getIntFld(i) + " ");
					if (i % 6 == 0)
						System.out.print(" | ");
				}
				System.out.println("!!!!!!");
