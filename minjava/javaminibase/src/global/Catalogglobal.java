...
public interface Catalogglobal {
	...
	final static String RELCATNAME = new String("relcat"); // name of relation
															// catalog
	final static String ATTRCATNAME = new String("attrcat"); // name of
																// attribute
																// catalog
	final static String INDEXCATNAME = new String("indcat");
	final static String RELNAME = new String("relname"); // name of indexed
															// field in
															// rel/attrcat
	...
	final static int DISTINCTKEYS = 20; // default statistic: no of distinct
										// keys
	...
	final static String MAXSTRINGVAL = new String("ZZZZZZZ"); // default
																// statisitic
