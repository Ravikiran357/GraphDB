...
class MRU extends Replacer {
	 ...
	 * of buffer allocated by buffer manager set each element of frame[] < 0
	 *
	 * @param mgr
	 *            Buffer manager
	 * @see BufMgr
	...
	/**
	 * Adding the frame with given frame number to buffer pool putting it in
	 * front of the list
	 *
	 * @param frameNo
	 *            the frame number
	 ...
	 * using MRU policy Update the buffer pool
	 * 
